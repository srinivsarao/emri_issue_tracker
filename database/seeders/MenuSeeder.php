...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menus = [
            ...
            ['display_name' => 'Role–Privilege Mapping', 'route_name' => 'role.privilege.mapping', 'uri' => '/role-privilege-mapping', 'display_order' => 23],
            ['display_name' => 'Working Hours', 'route_name' => 'working.hours', 'uri' => '/working-hours', 'display_order' => 24],
