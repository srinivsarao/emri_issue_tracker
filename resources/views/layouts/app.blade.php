...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="m-0 font-sans antialiased bg-slate-100 text-slate-900">
        <div x-data="{ sidebarOpen: false, openSections: {
            ...
            @php
                $menuGroups = [
                    ...
                    'User & Security' => ['user.master', 'role.master', 'privilege.master', 'user.role.mapping', 'user.project.mapping', 'user.support.group.mapping', 'role.privilege.mapping'],
