            ...
            <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-200 bg-slate-50 px-5 py-4">
                    <div class="flex flex-wrap items-center gap-3">
                        <button type="button" onclick="exportSupportGroupTable('csv')" class="rounded-lg border border-emerald-300 bg-emerald-100 px-3 py-2 text-sm font-semibold text-emerald-800 hover:bg-emerald-200">Export CSV</button>
                        <button type="button" onclick="exportSupportGroupTable('xlsx')" class="rounded-lg border border-emerald-300 bg-emerald-100 px-3 py-2 text-sm font-semibold text-emerald-800 hover:bg-emerald-200">Export XLSX</button>
                        <button type="button" onclick="exportSupportGroupTable('pdf')" class="rounded-lg border border-emerald-300 bg-emerald-100 px-3 py-2 text-sm font-semibold text-emerald-800 hover:bg-emerald-200">Export PDF</button>
                    </div>
                </div>
                    ...
                    <div class="max-h-[420px] overflow-auto">
                        <table class="min-w-full divide-y divide-slate-200">
                            <thead class="bg-slate-100 sticky top-0 z-10">
                                <tr>
                                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Support Group</th>
                                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Lead</th>
                                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Escalation Level</th>
                            ...
                            <tbody class="divide-y divide-slate-200 bg-white">
                                <tr>
                                    <td class="px-5 py-3 text-sm font-semibold text-slate-900">Operations Desk</td>
                                    <td class="px-5 py-3 text-sm text-slate-600">Suresh Gupta</td>
                                    <td class="px-5 py-3 text-sm text-slate-600">Level 1</td>
                                    ...
                                    <td class="px-5 py-3 text-sm">
                                        <div class="flex flex-wrap items-center gap-2">
                                            <button type="button" data-group-name="Operations Desk" data-lead="Suresh Gupta" data-escalation-level="Level 1" data-status="active" onclick="editSupportGroup(this.dataset)" class="rounded-lg bg-slate-900 px-2.5 py-1.5 text-xs font-semibold text-white hover:bg-slate-800">Edit</button>
                                ...
                                <tr>
                                    <td class="px-5 py-3 text-sm font-semibold text-slate-900">Customer Support</td>
                                    <td class="px-5 py-3 text-sm text-slate-600">Nidhi Rao</td>
                                    <td class="px-5 py-3 text-sm text-slate-600">Level 2</td>
                                    ...
                                    <td class="px-5 py-3 text-sm">
                                        <div class="flex flex-wrap items-center gap-2">
                                            <button type="button" data-group-name="Customer Support" data-lead="Nidhi Rao" data-escalation-level="Level 2" data-status="inactive" onclick="editSupportGroup(this.dataset)" class="rounded-lg bg-slate-900 px-2.5 py-1.5 text-xs font-semibold text-white hover:bg-slate-800">Edit</button>
